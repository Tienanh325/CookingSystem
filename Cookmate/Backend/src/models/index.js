...
NguoiDung.hasMany(LichAn, { foreignKey: 'idNguoiDung', as: 'lichAns' });
LichAn.belongsTo(NguoiDung, { foreignKey: 'idNguoiDung', as: 'nguoiDung' });
LichAn.hasMany(BuaAnTrongLich, { foreignKey: 'idLichAn', as: 'buaAns', onDelete: 'CASCADE' });
